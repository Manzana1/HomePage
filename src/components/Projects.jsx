  ...
  const projects = [
    ...
    },
    {
      ...
      description: {
        ...
        en: "Modern weather app developed with React, TypeScript, and Vite. It allows users to check the current temperature as well as a 5-day forecast, thanks to the integration of the OpenWeather API.",
      },
    },
  ];
